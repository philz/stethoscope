...
/*
Taken from 
org.gridkit.util.monitoring.Util, which is Apache Licensed.
 */
...
public class Util {
    ...
    public static void addSaJdiToClasspath() {
      addToolJarToClasspath("sa-jdi");
    }
    
    static void addToolJarToClasspath(String name) {
      try {
